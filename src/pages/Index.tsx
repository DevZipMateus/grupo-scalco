...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-brand-white overflow-x-hidden">
      ...
      <section className="relative py-4 sm:py-6 md:py-6 lg:py-8 flex items-center overflow-hidden min-h-[85vh] sm:min-h-[60vh] bg-cover bg-center bg-no-repeat bg-[url('/lovable-uploads/e22fa9ac-3996-468f-a64d-b277709c5e85.png')] md:bg-[url('/lovable-uploads/f7ae694a-5469-4848-8bae-5e53e1973bff.png')] md:bg-contain" style={{
