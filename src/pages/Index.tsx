          ...
          <div className="max-w-7xl mx-auto">
            <div className={`grid lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-12 items-center transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <div className="order-2 lg:order-1 text-center lg:text-left">
                ...
                <div className="bg-brand-yellow text-brand-dark-blue mb-3 sm:mb-4 px-2 sm:px-3 py-1 text-xs sm:text-sm font-semibold mt-4 inline-block rounded">
                  +80 empresas transformadas com o GAP
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2 sm:space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs sm:text-sm text-white break-all">scalco.pedro@gmail.com</span>
                  </div>
